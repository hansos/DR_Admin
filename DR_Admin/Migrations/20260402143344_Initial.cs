        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsDefault = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsCustomerCurrency = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsProviderCurrency = table.Column<bool>(type: "INTEGER", nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    NormalizedCode = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    NormalizedName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingCountryCode = table.Column<string>(type: "TEXT", maxLength: 2, nullable: false),
                    ...
                    VatValidationProvider = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    VatValidationRawResponse = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    ExchangeRateSource = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "INTEGER", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryCode = table.Column<string>(type: "TEXT", maxLength: 2, nullable: false),
                    StateCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    TaxName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    TaxCategory = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    TaxAuthority = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    TaxRegistrationNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Priority = table.Column<int>(type: "INTEGER", nullable: false),
                    InternalNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDomainGlobal = table.Column<bool>(type: "INTEGER", nullable: false),
                    NormalizedFirstName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    NormalizedLastName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedDepartment = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    ValueSourceType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "Manual"),
                    ValueSourceReference = table.Column<string>(type: "TEXT", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeRateDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ExchangeRateSource = table.Column<int>(type: "INTEGER", nullable: true),
                    TaxDeterminationEvidenceId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderTaxSnapshots_TaxDeterminationEvidences_TaxDeterminationEvidenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredDomainId = table.Column<int>(type: "INTEGER", nullable: true),
                    OrderId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    OrderId = table.Column<int>(type: "INTEGER", nullable: true),
                    OrderTaxSnapshotId = table.Column<int>(type: "INTEGER", nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentInstrument = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    PaymentInstrumentId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsDefault = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    DefaultGatewayId = table.Column<int>(type: "INTEGER", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PaymentInstrumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    PaymentGatewayId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsDefault = table.Column<bool>(type: "INTEGER", nullable: false),
                    Priority = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentInstrumentGateways_PaymentInstruments_PaymentInstrumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInstrumentGateways_PaymentInstrumentId_PaymentGatewayId",
                table: "PaymentInstrumentGateways",
