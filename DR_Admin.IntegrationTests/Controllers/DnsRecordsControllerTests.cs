...
public class DnsRecordsControllerTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    public async Task GetAllDnsRecords_WithAdminRole_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/v1/DnsRecords");

        // Assert
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);

        var result = await response.Content.ReadFromJsonAsync<IEnumerable<DnsRecordDto>>();
    ...
    public async Task GetDnsRecordById_ValidId_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.GetAsync($"/api/v1/DnsRecords/{recordId}");
    ...
    public async Task GetDnsRecordById_InvalidId_ReturnsNotFound()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/v1/DnsRecords/99999");
    ...
    public async Task GetDnsRecordsByDomainId_ValidDomainId_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.GetAsync($"/api/v1/DnsRecords/domain/{domainId}");
    ...
    public async Task GetDnsRecordsByType_ARecords_ReturnsOnlyARecords()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/v1/DnsRecords/type/A");
    ...
    public async Task GetDnsRecordsByType_WithSupportRole_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/v1/DnsRecords/type/CNAME");
    ...
    public async Task DeleteDnsRecord_ValidId_ReturnsNoContent()
    {
        ...
        // Act
        var response = await _client.DeleteAsync($"/api/v1/DnsRecords/{recordId}");
    ...
    public async Task DeleteDnsRecord_InvalidId_ReturnsNotFound()
    {
        ...
        // Act
        var response = await _client.DeleteAsync("/api/v1/DnsRecords/99999");
