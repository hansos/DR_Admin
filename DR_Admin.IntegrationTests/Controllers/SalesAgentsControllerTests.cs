...
public class SalesAgentsControllerTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    [Fact]
    [Trait("Category", "SalesAgents")]
    public async Task GetAllSalesAgents_WithAdminRole_ReturnsOk()
    {
        // Arrange
    ...
    private async Task<int> SeedSalesAgents()
    {
        ...
        await context.SalesAgents.AddAsync(agent);
        await context.SaveChangesAsync();
