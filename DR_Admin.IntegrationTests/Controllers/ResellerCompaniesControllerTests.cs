...
public class ResellerCompaniesControllerTests : IClassFixture<TestWebApplicationFactory>
{
    private readonly HttpClient _client;
    private readonly ITestOutputHelper _output;
    private readonly TestWebApplicationFactory _factory;

    public ResellerCompaniesControllerTests(TestWebApplicationFactory factory, ITestOutputHelper output)
    {
        _factory = factory;
    ...
    [Fact]
    [Trait("Category", "ResellerCompanies")]
    public async Task GetAllResellerCompanies_WithAdminRole_ReturnsOk()
    {
        // Arrange
        await SeedResellerCompanies();
        ...
        _output.WriteLine("Retrieved reseller companies");
    }
    ...
    private async Task<int> SeedResellerCompanies()
    {
        ...
        await context.ResellerCompanies.AddAsync(company);
