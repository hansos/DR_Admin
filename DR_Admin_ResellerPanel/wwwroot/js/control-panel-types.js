...
(function () {
    ...
    function initializeControlPanelTypesPage() {
        ...
        (_a = document.getElementById('control-panel-types-create')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', openCreate);
        (_b = document.getElementById('control-panel-types-save')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', saveControlPanelType);
        (_c = document.getElementById('control-panel-types-confirm-delete')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', doDelete);
        bindTableActions();
        loadControlPanelTypes();
    }
