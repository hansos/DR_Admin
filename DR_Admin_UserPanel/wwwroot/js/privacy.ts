...
function initializePrivacyPage(): void {
...
async function loadPrivacySummary(): Promise<void> {
...
function renderPrivacySummary(account: UserAccountDto): void {
...
function escapePrivacyText(value: string): string {
    return value
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
        .replace(/>/g, '&gt;')
...
function setupPrivacyObserver(): void {
