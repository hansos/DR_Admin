...
namespace PaymentGatewayLib.Implementations
{
    public class JamboPayPaymentGateway : BasePaymentGateway, IPaymentGateway
    {
        ...
        public JamboPayPaymentGateway(string merchantId, string apiKey, bool useTestMode = true) { _logger = Log.ForContext<JamboPayPaymentGateway>(); _merchantId = merchantId ?? throw new ArgumentNullException(nameof(merchantId)); _apiKey = apiKey ?? throw new ArgumentNullException(nameof(apiKey)); }
