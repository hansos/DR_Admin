...
namespace PaymentGatewayLib.Implementations
{
    public class BitPayPaymentGateway : BasePaymentGateway, IPaymentGateway
    {
        ...
        public BitPayPaymentGateway(string apiToken, bool useTestMode = true) { _logger = Log.ForContext<BitPayPaymentGateway>(); _apiToken = apiToken ?? throw new ArgumentNullException(nameof(apiToken)); }
