...
namespace PaymentGatewayLib.Implementations
{
    public class NetsPaymentGateway : BasePaymentGateway, IPaymentGateway
    {
        ...
        public NetsPaymentGateway(string secretKey, bool useTestMode = true) { _logger = Log.ForContext<NetsPaymentGateway>(); _secretKey = secretKey ?? throw new ArgumentNullException(nameof(secretKey)); }
